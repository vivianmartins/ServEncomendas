...
@NamedQueries({
        ...
        @NamedQuery(name = "Encomendas.findAllPed",  query = "select distinct new   com.bd.DAL.listaPedidos  (en,  estenc, pr, ee, pre, tps)  from Encomendas  en, Estadosencomenda estenc, Pratos  pr, Encomendaestados ee, PratosEncomendados pre, Tipopagamentos  tps where en.idEncomenda = pre.idEncomenda and  pr.idPrato = pre.idPrato"),
